...
import { saveCommonTokenToStore, saveCurrentUserToStore } from "redux/actions/actionAuth";
...
// helpers | common
import { getFromLocalStorage, saveToLocalStorage } from "utlis/helpers/Common/CommonHelperFunctions";
...
function Layout(props) {
    ...
    useEffect(() => {
        ...
        if (userFromLocalStorage) {
            ...
            getCartItems(userDetails.userToken, userDetails.tempOrderId).then(res => {
                ...
                if (resData.success) {
                    ...
                    // generating items
                    cartData?.content.forEach(item => cartItems.push({
...
const dispatchActionsToProps = (dispatch) => {
    return {
        ...
        saveCommonTokenToStore: (token) => dispatch(saveCommonTokenToStore(token)),
        saveCurrentUserToStore: (user) => dispatch(saveCurrentUserToStore(user)),
