...
// CUSTOMER PAGES
export const ERROR_WHILE_FETCHING_CUSTOMERS = "Unable to load Customers. Please try again."
export const ERROR_WHILE_DELETING_CUSTOMER = "No details found."
export const CONFIRMATION_BEFORE_DELETING_CUSTOMER = "Are you sure you want to delete this customer?"
export const CUSTOMER_DELETED_SUCCESSFULLY = "Customer deleted successfully."
// create
export const CUSTOMER_ADDED_SUCCESSFULLY = "Customer created successfully."
export const ERROR_WHILE_CREATING_CUSTOMER = "Error occured!! Please check if all the required fields are filled correctly."
// // edit
export const CUSTOMER_UPDATED_SUCCESSFULLY = "Customer Updated successfully."
export const ERROR_WHILE_UPDATING_CUSTOMER = "Error occured!! please check if all the required fields are filled correctly."
export const ERROR_WHILE_GETTING_CUSTOMER_DETAILS = "Unable to get the customer details. Please try again"

//ADD CUSTOMER 
export const ERROR_WHILE_FETCHING_ADDRESS = "Unable to load Customers. Please try again."
export const ERROR_WHILE_DELETING_ADDRESS = "No details found."
export const CONFIRMATION_BEFORE_DELETING_ADDRESS = "Are you sure you want to delete this address?"
...
export const ERROR_WHILE_CREATING_ADDRESS = "Error occured!! Please check if all the required fields are filled correctly."
// // edit address
export const ADDRESS_UPDATED_SUCCESSFULLY = "Address Updated successfully."
export const ERROR_WHILE_UPDATING_ADDRESS = "Error occured!! please check if all the required fields are filled correctly."
export const ERROR_WHILE_GETTING_ADDRESS_DETAILS = "Unable to get the address details. Please try again"
...
// BLOGS PAGES
export const ERROR_WHILE_FETCHING_BLOGS = "Unable to load Blogs. Please try again."
export const ERROR_WHILE_DELETING_BLOG = "No details found."
export const CONFIRMATION_BEFORE_DELETING_BLOG = "Are you sure you want to delete this blog?"
export const BLOG_DELETED_SUCCESSFULLY = "Blog deleted successfully."
// create
export const BLOG_ADDED_SUCCESSFULLY = "Blog created successfully."
export const ERROR_WHILE_CREATING_BLOG = "Error occured!! Please check if all the required fields are filled correctly."
// // edit
export const BLOG_UPDATED_SUCCESSFULLY = "Blog Updated successfully."
export const ERROR_WHILE_UPDATING_BLOG = "Error occured!! please check if all the required fields are filled correctly."
export const ERROR_WHILE_GETTING_BLOG_DETAILS = "Unable to get the blog detail. Please try again"


// CUSTOMER GROUPS PAGES
export const ERROR_WHILE_FETCHING_CUSTOMERGROUPS = "Unable to load Customer Groups. Please try again."
export const ERROR_WHILE_DELETING_CUSTOMERGROUP = "No details found."
export const CONFIRMATION_BEFORE_DELETING_CUSTOMERGROUP = "Are you sure you want to delete this customer group?"
export const CUSTOMERGROUP_DELETED_SUCCESSFULLY = "Customer Group deleted successfully."
// create
export const CUSTOMERGROUP_ADDED_SUCCESSFULLY = "Customer Group created successfully."
export const ERROR_WHILE_CREATING_CUSTOMERGROUP = "Error occured!! Please check if all the required fields are filled correctly."
// // edit
export const CUSTOMERGROUP_UPDATED_SUCCESSFULLY = "Customer Group Updated successfully."
export const ERROR_WHILE_UPDATING_CUSTOMERGROUP = "Error occured!! please check if all the required fields are filled correctly."
export const ERROR_WHILE_GETTING_CUSTOMERGROUP_DETAILS = "Unable to get the customer group detail. Please try again"
